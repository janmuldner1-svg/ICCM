...
if (file.exists("data/palm_tree_concessions.json")) {
  palm_concessions <- st_read("data/palm_tree_concessions.json")
  ...
  sidebarLayout(
    sidebarPanel(
      checkboxGroupInput(
        "layer",
        "Layers:",
        choices = c("Palm Mismatches", "Palm Concessions", "Kayong Boundary", "Timber Mismatches"),
        selected = c("Palm Mismatches", "Palm Concessions", "Kayong Boundary", "Timber Mismatches")
      ),
      width = 3
    ),
